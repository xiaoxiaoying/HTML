...
function ChangeSon()
{
    ...
    */
    ...
    document.getElementById('exampleInputEmail2').value = this.options[this.selectedIndex].text;
    //document.getElementById('hidden_'+emname).value = this.options[this.selectedIndex].value;
    var newobj = oj.options;
...
function ChangeSec()
{
    ...
    var topSelObj = document.getElementById(emname+'_top');
    if(this.options[this.selectedIndex].value==0) {
        document.getElementById('sec_'+emname).value = topSelObj.options[topSelObj.selectedIndex].text;
        //alert(topSelObj.options[topSelObj.selectedIndex].text);
    }
    else {
        document.getElementById('sec_'+emname).value = this.options[this.selectedIndex].text;
        //alert(this.options[this.selectedIndex].text);
    }
}
...
function selNextSon()
{
    ...
    var v = this.options[this.selectedIndex].value;
    document.getElementById('hidden_'+emname).value =this.options[this.selectedIndex].text;
    var newobj = oj.options;
    var selarr = eval('em_'+emname+'s');
    var selv = parseInt(v);
    var maxv = parseInt(v) + 500;
